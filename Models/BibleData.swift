...
// Define BibleData as a class with proper initialization
class BibleData {
    static let shared = BibleData()
    
    static let bibleBooks: [BibleBook] = [
        ...
        static let chapterVerseCount: [String: [Int: Int]] = [
    ...
    private init() {
        ...
        // Helper methods for accessing Bible data
        static func getBook(named name: String) -> BibleBook? {
            return bibleBooks.first { $0.name == name }
        }
        
        static func getMaxChapter(for book: String) -> Int? {
            return chapterVerseCount[book]?.count
        }
        
        static func getVerseCount(for book: String, chapter: Int) -> Int? {
            return chapterVerseCount[book]?[chapter]
        }
    }
