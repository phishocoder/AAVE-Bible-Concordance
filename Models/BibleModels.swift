...
public struct Verse: Codable, Hashable {
    ...
    public init(text: String, translation: String, reference: VerseReference) {
        self.text = text
...
public struct VerseRange: Hashable, Codable {
    ...
    public init(book: String, chapter: Int, startVerse: Int, endVerse: Int) {
        self.book = book
        self.chapter = chapter
...
public struct TraditionalVerse: Codable, Hashable {
    ...
    public init(text: String, version: String) {
        self.text = text
...
public struct BibleBook: Identifiable, Codable, Hashable {
    ...
    public init(name: String, chapters: Int, testament: Testament) {
        self.name = name
    ...
    public static func == (lhs: BibleBook, rhs: BibleBook) -> Bool {
...
public enum BibleError: Error {
    ...
    public var localizedDescription: String {
        ...
        case .verseNotFound: return "Verse not found"
        case .invalidBook: return "Invalid book reference"
        case .invalidChapter: return "Invalid chapter reference"
        case .storageError: return "Failed to access local storage"
        case .decodingError: return "Failed to decode data"
        case .invalidData: return "Invalid data format"
        case .unknown: return "An unknown error has occured"
        case .notLoaded: return "Translation data not loaded"
        case .translationNotFound: return "Translation files not found"
...
// MARK: - Bible Data
public let bibleBooks: [BibleBook] = [
    // Old Testament
    ...
    // Add these to the existing BibleModels.swift file, before the last closing brace

public let chapterVerseCount: [String: [Int: Int]] = [
    // Old Testament
    ...
    "Ezekiel": [1: 28, 2: 10, 3: 27, 4: 17, 5: 17, 6: 14, 7: 27, 8: 18, 9: 11, 10: 22, 11: 25, 12: 28, 13: 23, 14: 23, 15: 8, 16: 63, 17: 24, 18: 32, 19: 14, 20: 44, 21: 32, 22: 31, 23: 49, 24: 27, 25: 17, 26: 21, 27: 36, 28: 26, 29: 21, 30: 26, 31: 18, 32: 32, 33: 33, 34: 31, 35: 15, 36: 38, 37: 28, 38: 23, 39: 29, 40: 49, 41: 26, 42: 20, 43: 27, 44: 31, 45: 25, 46: 24, 47: 23, 48: 35],
